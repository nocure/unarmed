...
#define DOWN_MATRIX			(1<<0)
#define OLD_ADTS_FORMAT		(1<<1)
#define YL_HW_IMDCT			(1<<2)
// ww 2010-0927 added <--
...
// ww 2010-0927 modified --> combined few boolean items into 1 option
