...
#undef _WIN32		// to use default math macros
//#define USE_C_CODE_MATH	// use added by ww c math functions
...
#elif defined(USE_C_CODE_MATH)
// ww modified and added -->
static INLINE real_t MUL_R(real_t A, real_t B){
	long long int temp = (long long int) A * B;
	temp = temp >> REAL_BITS;
	return (int) temp;
}
