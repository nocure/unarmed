...
fb_info *filter_bank_init(uint16_t frame_len, uint8_t hw_imdct)
// ww 2010-0927 modified <--
{
    uint16_t nshort = frame_len/8;
#ifdef LD_DEC
    uint16_t frame_len_ld = frame_len/2;		// 1024 /2
#endif
    ...
    /* normal */
    fb->mdct256 = faad_mdct_init(2*nshort,hw_imdct);
    fb->mdct2048 = faad_mdct_init(2*frame_len,hw_imdct);
#ifdef LD_DEC
    /* LD */
    fb->mdct1024 = faad_mdct_init(2*frame_len_ld,hw_imdct);
#endif
