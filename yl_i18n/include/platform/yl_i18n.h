...
int UCS2ToMultiByte(DWORD CodePage, DWORD dwFlags, const ucs2_t *ucs2str, int ucslen, char *mbstr, int mblen);
int MultiByteToUCS2(DWORD CodePage, const char *mbstr, int mblen, ucs2_t *ucs2buf, int ucslen);
