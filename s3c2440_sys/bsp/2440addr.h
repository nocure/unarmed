...
#define S3C2440_CS0		0x00000000
#define S3C2440_CS1		0x08000000
#define S3C2440_CS2		0x10000000
#define S3C2440_CS3		0x18000000		// cs8900
#define S3C2440_CS4		0x20000000		// dm9000
#define S3C2440_CS5		0x28000000
#define S3C2440_CS6		0x30000000
#define S3C2440_CS7		0x38000000
// Ethernet Interface
#define rETHREGADDR		(*(volatile unsigned char *)0x20000000)
#define rETHREGDATB		(*(volatile unsigned char *)0x20000004)		// 8 bit
#define rETHREGDATW		(*(volatile unsigned short *)0x20000004)		// 16 bit
#define rETHREGDATL		(*(volatile unsigned int *)0x20000004)		// 32 bit
