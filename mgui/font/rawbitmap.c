...
extern const INCORE_RBFINFO __mgif_fixed6x12_iso8859_1;

#ifdef _INCORERBF_LATIN1_16
extern const INCORE_RBFINFO __mgif_fixed8x16_iso8859_1;
#endif
...
extern const INCORE_RBFINFO __mgif_ming12_big5;
#endif
...
static const INCORE_RBFINFO* incore_rbfonts [] = {
...
BOOL InitIncoreRBFonts (void)
{
    ...
    for (i = 0; i < NR_RBFONTS; i++) {
        ...
        if (!fontGetCharsetFromName (incore_rbfonts [i]->name, charset)) {
            dbgout ("GDI: Invalid font name (charset): %s.\n",
...
error_load:
    dbgout ("GDI: Error in initializing incore raw bitmap fonts!\n");
...
/**************************** Global data ************************************/
const FONTOPS raw_bitmap_font_ops = {
    get_char_width,
    get_ave_width,
