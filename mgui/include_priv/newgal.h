/*
** $Id: newgal.h 7811 2007-10-11 05:41:32Z weiym $
**
...
#define GAL_OutOfMemory()   dbgout ("Out of memory\n")
#define GAL_SetError        dbgout
...
extern void Slave_VideoQuit (GAL_Surface * surface);
extern GAL_Surface *Slave_VideoInit(const char* driver_name, const char* mode);
