...
/*
 * $Id: fixedmath.h 7364 2007-08-16 05:20:20Z xgwang $
 *
...
extern MG_EXPORT const fixed _cos_tbl[];
extern MG_EXPORT const fixed _tan_tbl[];
extern MG_EXPORT const fixed _acos_tbl[];
