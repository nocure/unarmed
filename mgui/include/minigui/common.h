...
/*
 * $Id: common.h 9943 2008-04-01 05:16:49Z xwyan $
 *
...
// ww: library configuration defines

//#define __THREADX__
#define __OSWRAP__
#define _LITE_VERSION
#define _FIXED_MATH
#define _RBF_SUPPORT
#define _INCORE_RES
#define _USE_NEWGAL
//#define _ADV_2DAPI
//#define _HAVE_MATH_LIB
#define _CURSOR_SUPPORT
#define _JPG_FILE_SUPPORT

//#define _INCORERBF_LATIN1_16

#define _BIG5_SUPPORT
//#define _UNICODE_SUPPORT
#define _MGFONT_RBF
#define _MGINCORERBF_BIG5_12
#define _INCORERBF_BIG5_12
//#define _MGINCORERBF_BIG5_16

//#define _NEED_STOCKBMP_BUTTON

//#define _NEWGAL_ENGINE_SHADOW
...
/* ccchiu add for pthread APIs mapping, but no mapping for
 * pthread_create , no pthread_key_*, pthread_get(set)specific,
 * pthread_attr_* corresponding functions
 */
typedef  TX_THREAD		pthread_t;
typedef  TX_MUTEX		pthread_mutex_t;
typedef  TX_SEMAPHORE	sem_t;

//#define		pthread_t		TX_THREAD
//#define		pthread_mutex_t	TX_MUTEX

#define pthread_mutex_init(mutex,attr) tx_mutex_create(mutex,"",TX_NO_INHERIT)
#define pthread_mutex_destroy tx_mutex_delete
#define pthread_mutex_lock(mutex) tx_mutex_get(mutex,TX_WAIT_FOREVER)
#define pthread_mutex_unlock tx_mutex_put
...
#define pthread_mutex_init(mutex,attr) cre_sem(mutex,0,1)
#define pthread_mutex_destroy(mutex) del_sem(mutex);
#define pthread_mutex_lock(mutex) wai_sem(mutex)
#define pthread_mutex_unlock(mutex) yl_sig_sem(mutex)
...
#if defined (__UCOSII__) || defined (__NUCLEUS__) || defined (__PSOS__)
